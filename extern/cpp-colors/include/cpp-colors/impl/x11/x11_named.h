    ...
    struct basic_color_mapper {
      ...
      static const string_color_map &get_string_to_color_map() {
        ...
        if (sm_.empty()) {
          ...
          sm_.insert(std::make_pair(to_lowercase(named_color_type::fire_brick()), known_color::fire_brick));
          ...
          sm_.insert(std::make_pair(to_lowercase(named_color_type::seashell()), known_color::seashell));
          ...
          sm_.insert(std::make_pair(to_lowercase(named_color_type::light_grey()), known_color::light_grey));
      ...
      static const color_string_map &get_color_to_string_map() {
        ...
        if (vm_.empty()) {
          ...
          vm_.insert(std::make_pair(value_of(known_color::fire_brick), named_color_type::fire_brick()));
          ...
          vm_.insert(std::make_pair(value_of(known_color::seashell), named_color_type::seashell()));
          ...
          vm_.insert(std::make_pair(value_of(known_color::light_grey), named_color_type::light_grey()));
