...
constexpr flicks k_flicks_24fps{29400000};
...
constexpr flicks k_flicks_one_thirtieth_second{
    std::chrono::duration_cast<flicks>(
        std::chrono::duration<flicks::rep, std::ratio<1, 30>>{1})};
constexpr flicks k_flicks_one_sixtieth_second{
    std::chrono::duration_cast<flicks>(
        std::chrono::duration<flicks::rep, std::ratio<1, 60>>{1})};
constexpr flicks k_flicks_one_fifteenth_second{
    std::chrono::duration_cast<flicks>(
        std::chrono::duration<flicks::rep, std::ratio<1, 15>>{1})};
...
constexpr flicks k_flicks_low{std::numeric_limits<flicks::rep>::lowest()};
constexpr flicks k_flicks_max{std::numeric_limits<flicks::rep>::max()};
