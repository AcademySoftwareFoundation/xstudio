    ...
    if(VCPKG_EXECUTABLE EQUAL "" OR NOT DEFINED VCPKG_EXECUTABLE)
        ...
        if(NOT VCPKG_TEST_RETVAL EQUAL "0")
            ...
            if(NOT EXISTS "${CMAKE_CURRENT_SOURCE_DIR}/vcpkg.json")
                ...
                message(STATUS "If you need an empty manifest for setting up your project, you will find one in your build directory")
            endif()
        endif()
        ...
        set(VCPKG_DIRECTORY ${VCPKG_DIRECTORY} CACHE STRING "VCPKG directory" FORCE)
        message(STATUS "VCPKG_DIRECTORY: ${VCPKG_DIRECTORY}")
...
function(vcpkg_manifest_generation_finalize)
    message(STATUS "VCPKG is creating the manifest")
    if(CMAKE_VERSION VERSION_GREATER_EQUAL 3.19)
