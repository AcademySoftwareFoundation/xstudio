...
if (IlmBase_FOUND)
    if (NOT TARGET IlmBase::IlmBase)
        add_library(IlmBase::IlmBase INTERFACE IMPORTED)
    endif()
    set_property(TARGET IlmBase::IlmBase PROPERTY INTERFACE_INCLUDE_DIRECTORIES "${ILMBASE_INCLUDE_DIRS}")
    set_property(TARGET IlmBase::IlmBase PROPERTY INTERFACE_LINK_LIBRARIES "${ILMBASE_LIBRARIES}")
endif()
