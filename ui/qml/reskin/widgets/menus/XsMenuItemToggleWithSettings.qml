...
Item {
    ...
    property bool isChecked: isRadioButton? 
                                    radioSelectedChoice==label : 
                                    is_checked? is_checked : false //#TODO
    ...
    property real menuRealWidth: checkBox.width + labelMetrics.width + settingsBtn.width + (checkBoxPadding*2) + (labelPadding)
    ...
    //     }
    // }
    Rectangle{anchors.fill: checkBox; color: bgColorPressed; visible: isChecked; scale: 0.8}         
    Image {
        id: checkBox
        source: isRadioButton? 
            isChecked?  "qrc:/icons/radio_button_checked.svg" : "qrc:/icons/radio_button_unchecked.svg" :
    ...
    XsSecondaryButton{ id: settingsBtn
        width: checkBoxSize
        height: checkBoxSize
        anchors.right: parent.right
        anchors.rightMargin: checkBoxPadding
        anchors.verticalCenter: parent.verticalCenter
