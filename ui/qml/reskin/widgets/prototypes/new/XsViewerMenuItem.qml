...
MenuItem {
    ...
    property real iconsize: 16 //XsStyle.menuItemHeight *.66
    ...
    indicator: Item {
        ...
        Rectangle {
            ...
            Image {
                id: checkIcon
                visible: true
                source: widget.multiCheckable? widget.checked? "qrc:/assets/icons/new/check_box_checked.svg" : "qrc:/assets/icons/new/check_box_unchecked.svg"
