...
import "./quickview/"
import "../utility/"
import "./menus/help_menu" // for XsReleaseNotes
...
ApplicationWindow {
    ...
    FontLoader {id: fontVera; source: "qrc:/assets/fonts/VeraMono.ttf"}
    ...
    Component.onCompleted: {
        ...
        // grading = 6.0
        // annotation = 7.0
        viewsModel.register_view("qrc:/application/panels/notes/XsNotesView.qml", "Notes", 8.0)
        ...
        popoutWindowsModel.register_popout_window(
            "Notes",
            "qrc:/application/panels/notes/XsNotesView.qml",
        ...
        singletonsModel.register_singleton_qml("qrc:application/panels/notes/XsNotesSingleton.qml")
    ...
    XsPreference {
        ...
        function set() {
            XsStyleSheet.useFlatTheme = value
        }
    }
    ...
    XsPreference {
        ...
        function set() {
            if (typeof value == "number") {
                XsStyleSheet.luminance = 100.0/value
            }
        }
    }
    ...
    XsPreference {
        ...
        function set() {
            if (typeof value == "number") {
                XsStyleSheet.textLuminance = 100.0/value
            }
        }
    }
