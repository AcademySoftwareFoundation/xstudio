...
Rectangle {
    ...
    property color timelineBackground: XsStyleSheet.panelBgColor
    property color timelineText: Qt.darker("#AFAFAF", XsStyleSheet.textLuminance)
    property color trackBackground:  Qt.darker("#474747", XsStyleSheet.luminance)
    property color trackEdge: Qt.darker("#3B3B3B", XsStyleSheet.luminance)
    property color defaultClip: Qt.darker("#888888", XsStyleSheet.luminance)
