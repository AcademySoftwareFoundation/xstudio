...
Item {
	...
	XsGradientRectangle {
		...
		border.width: 1
        border.color: (isHovered || dragTarget) ? XsStyleSheet.accentColor : "transparent"

		flatColor: topColor

        topColor: isSelected ? Qt.darker(XsStyleSheet.accentColor, 2) : XsStyleSheet.panelBgGradTopColor
        bottomColor: isSelected ? Qt.darker(XsStyleSheet.accentColor, 2) :  XsStyleSheet.baseColor
	...
	Rectangle {
        ...
        color: isSizerDragging ? XsStyleSheet.accentColor : isSizerHovered  ? XsStyleSheet.secondaryTextColor : timelineBackground
