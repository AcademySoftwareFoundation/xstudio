...
Rectangle{
    ...
    ****************************************************************/
    ...
    property color highlightColor: XsStyleSheet.accentColor
    property color bgColorPressed: Qt.darker(XsStyleSheet.accentColor, 3)
            ...
            Rectangle{ id: thumbDiv
                ...
                XsMediaThumbnailImage {
                    ...
                    Rectangle {
                        ...
                        y: -width/2
                        gradient: Gradient {
                            GradientStop { position: 0.75; color: isSelected ? XsStyleSheet.accentColor : "#66000000" }
                ...
                //     // radius: width/2
                //     border.width: 0
                //     border.color: XsStyleSheet.primaryTextColor
