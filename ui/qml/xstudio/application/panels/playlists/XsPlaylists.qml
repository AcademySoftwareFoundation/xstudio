...
Item{
    ...
    readonly property int btnHeight: XsStyleSheet.widgetStdHeight + 4
        ...
        RowLayout{
            ...
            XsPrimaryButton{
                ...
                onClicked: {
                    ...
                    togglePlusMenu(pos.x ,pos.y, this)
                }
            }
            ...
            XsPrimaryButton{
                ...
                onClicked: toggleRemoveMenu(width / 2, height / 2, this)
            }
            ...
            XsPrimaryButton{
                ...
                onClicked: toggleContextMenu(width / 2, height / 2, this)
            }
        }
