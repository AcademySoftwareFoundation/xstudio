   ...
   Component.onCompleted: {
    ...
    XsHotkey {
        ...
        onActivated: (menuContext) =>  {
            if(menuContext.startsWith("timelinexstudio::ui::qml"))
                replaceSelectionTimeline(name, sessionData.currentTimelineSelection)
            else
			...
			Item {
                ...
                XsMenuModelItem {
                    ...
                    onActivated: (menuContext) =>  {
                        ...
                        delayCallback(500, function() {autoConformSelectionTimeline(text, menuContext.theTimeline.conformSourceIndex, new_index)})
                    }
                }
