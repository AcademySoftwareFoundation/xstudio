...
Rectangle {
	id: control
   	...
   	property bool move_visible: true
	...
	property bool more_button_holder: true
   	...
   	property alias move_button: move_button
    ...
    Rectangle {
        ...
        // gradient: move_ma.containsMouse ? styleGradient.accent_gradient : null
        color: "transparent"
        width: icon_width+4
        height: width
	    Image {
		    ...
		    layer {
		        enabled: true
		        effect: ColorOverlay {
		            color: move_ma.containsMouse ? XsStyle.highlightColor : XsStyle.controlBackground
		        }
		    }
	    }
