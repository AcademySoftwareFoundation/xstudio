...
Rectangle {
    ...
    property var currentPlaylist: session.playlist
  ...
  DelegateChooser {
    ...
    DelegateChoice {
      ...
      XsPlaylistGroupWidget {
        anchors.left: parent.left
        anchors.right: parent.right
        text: object.name
        type: object.type
        backend: object
        parent_backend: session
        listView: layout
          listViewIndex: index
      }
    }
    ...
    DelegateChoice {
      ...
      XsDraggableItem {
        ...
        XsPlaylistWidget {
          ...
          internal_drag_drop_cursor: internalDragDropCursor
          internal_drag_drop_source_playlist_uuid: dragdropSourcePlaylistUuid
