...
Slider{ id: widget
    ...
    property color fillColor: XsStyleSheet.accentColor
    property color baseColor: XsStyleSheet.panelBgColor
    property color handleColor: XsStyleSheet.primaryTextColor
    ...
    handle: Rectangle {
        ...
        border.color: widget.hovered? XsStyleSheet.accentColor : "black"
    }
