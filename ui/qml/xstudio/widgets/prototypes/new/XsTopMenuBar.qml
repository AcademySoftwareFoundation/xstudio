...
MenuBar  {
    ...
    delegate: MenuBarItem {
        id: menuBarItem
        height: 24 //XsStyle.menuBarHeight
        contentItem: Text {
            ...
            color: "yellow" //XsStyle.hoverColor//menuBarItem.highlighted ? XsStyle.hoverColor : XsStyle.mainColor
...
//            color: menuBarItem.menu.opened?XsStyle.highlightColor : "transparent"
            color: menuBarItem.menu.opened? "blue": "transparent"
