...
ScrollBar {
    ...
    property color thumbColorPressed: XsStyleSheet.accentColor
    property color thumbColorHovered: XsStyleSheet.primaryTextColor
    ...
    Rectangle { id: thumb
        ...
        implicitHeight: 5
        radius: width / 1.1
        color: pressed ? thumbColorPressed: thumbColorNormal
        border.color: pressed ? "transparent" : Qt.lighter(thumbColorNormal, 1.0+Math.abs(borderGlow-1.0))
        border.width: 1
