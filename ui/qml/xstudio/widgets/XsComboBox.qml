...
ComboBox { id: widget
    ...
    property color bgColorEditable: Qt.darker(XsStyleSheet.widgetBgNormalColor, 0.5)
    property color bgColorActive: XsStyleSheet.accentColor
    ...
    property color textColorSelected: XsStyleSheet.primaryTextColor
    ...
    ItemDelegate {
        ...
        palette.highlightedText: XsStyleSheet.accentColor
