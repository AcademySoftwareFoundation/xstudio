...
Control
{
    ...
    RowLayout {
        ...
        XsTextField{ 
            id: valueDiv
            visible: text
            text: value.toFixed(float_display_decimals)
    ...
    MouseArea{
        ...
        property real valueOnPress: defaultValue
        property real lastValue: defaultValue
        ...
        onMouseXChanged: {
            ...
            if(pressed) {
                ...
                console.log("valueOnPress: ", valueOnPress)
                console.log("mouseX: ", mouseX)
                console.log("mouseXOnPress: ", mouseXOnPress)
                console.log("stepSize: ", stepSize)
                console.log("fromValue: ", fromValue)
                console.log("max: ", Math.max(valueOnPress + (mouseX - mouseXOnPress)*stepSize, fromValue))
                console.log("min: ", Math.min(toValue, Math.max(valueOnPress + (mouseX - mouseXOnPress)*stepSize, fromValue)))
            }
        }
