...
Item {
    ...
    function showSubMenu() {
        ...
        menu_model.nodeActivated(menu_model_index, "shown", helpers.contextPanel(widget))
    }
    ...
    MouseArea
    {
        ...
        onClicked: {
            ...
            if (!sub_menu) {
                ...
                menu_model.nodeActivated(menu_model_index, "clicked", helpers.contextPanel(widget))
    ...
    RowLayout {
        ...
        XsIcon {
            ...
            imgOverlayColor: widget.isSubMenuActive? XsStyleSheet.accentColor : hotKeyColor
