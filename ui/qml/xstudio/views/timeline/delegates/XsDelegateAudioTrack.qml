...
Rectangle {
	...
	XsTrackHeader {
		...
		onConformSourceClicked: conformSourceIndex = helpers.makePersistent(DelegateModel.model.modelIndex(index))
		onFlagSet: flagItems([DelegateModel.model.modelIndex(index)], flag == "#00000000" ? "": flag)
	}
