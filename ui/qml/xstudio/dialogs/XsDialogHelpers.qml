                ...
                GridLayout {
                    ...
                    Rectangle {
                        ...
                        XsTextField{ id: maxCount
                            ...
                            background: Rectangle{
                                color: maxCount.activeFocus? Qt.darker(XsStyleSheet.accentColor, 1.5): maxCount.hovered? Qt.lighter(XsStyleSheet.panelBgColor, 2):Qt.lighter(XsStyleSheet.panelBgColor, 1.5)
