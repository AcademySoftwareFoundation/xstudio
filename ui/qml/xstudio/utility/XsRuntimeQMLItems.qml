...
Item {
    ...
    DelegateModel {
        ...
        delegate: Item {
            ...
            // This allows one to run a callback to a python method on a parent plugin from
            // an xSTUDIO UI panel with up to 10 arguments.
            // See AnnotationsExportDialog.qml for and annotations_exporter.py
            // for an example
            function python_callback(python_func_name, _1, _2, _3, _4, _5, _6, _7, _8, _9, _10) {

                // trim null arguments so that v has the same number of elements
                // as the call to python_callback
