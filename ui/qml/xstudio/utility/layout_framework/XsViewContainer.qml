...
Item {
    ...
    Component {
        ...
        Item {
            ...
            Rectangle
            {   id: tabItem
                color: selected? XsStyleSheet.panelBgGradTopColor : XsStyleSheet.baseColor //#TODO: to check with UX
                border.color: mouseArea.containsMouse ? XsStyleSheet.accentColor : "transparent"
                border.width: 1
