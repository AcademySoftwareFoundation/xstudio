...
class CompositeViewportLayout : public ViewportLayoutPlugin {
  public:
    CompositeViewportLayout(caf::actor_config &cfg, const utility::JsonStore &init_settings);

    ~CompositeViewportLayout() override = default;

    inline static const utility::Uuid PLUGIN_UUID = {"fdb9204f-f00f-4345-8616-b7bfbedc5829"};
