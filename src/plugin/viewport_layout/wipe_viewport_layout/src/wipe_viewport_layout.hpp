...
namespace ui {
    namespace viewport {
        ...
        class WipeViewportLayout : public ViewportLayoutPlugin {
          public:
            WipeViewportLayout(caf::actor_config &cfg, const utility::JsonStore &init_settings);

            ~WipeViewportLayout() override = default;

            inline static const utility::Uuid PLUGIN_UUID = {
                "fa41b47a-6fde-4627-bd38-6e7834e75007"};

          protected:
            virtual ViewportRenderer *make_renderer(
