...
static void InitDeckLinkAPI(void) {
    ...
    gCreateVideoFrameAncillaryPacketsFunc = (CreateVideoFrameAncillaryPacketsInstanceFunc)dlsym(
        libraryHandle, "CreateVideoFrameAncillaryPacketsInstance_0001");
...
static void InitDeckLinkPreviewAPI(void) {
    ...
    gCreateOpenGLPreviewFunc = (CreateOpenGLScreenPreviewHelperFunc)dlsym(
        libraryHandle, "CreateOpenGLScreenPreviewHelper_0002");
    if (!gCreateOpenGLPreviewFunc)
        fprintf(stderr, "%s\n", dlerror());
    gCreateOpenGL3PreviewFunc = (CreateOpenGL3ScreenPreviewHelperFunc)dlsym(
...
bool IsDeckLinkAPIPresent_v15_2(void) {
    // If the DeckLink API dynamic library was successfully loaded, return this knowledge to the
    // caller
