...
public:
    ...
    virtual HRESULT AttachPacket (/* in */ IDeckLinkAncillaryPacket_v15_2* packet) = 0;	// Implement IDeckLinkAncillaryPacket_v15_2 to output your own
...
extern "C" {
    BMD_PUBLIC IDeckLinkVideoFrameAncillaryPackets_v15_2* CreateVideoFrameAncillaryPacketsInstance_v15_2(void);	// For use when creating a custom IDeckLinkVideoFrame without wrapping IDeckLinkOutput::CreateVideoFrame
}

#endif /* defined(BMD_DECKLINKAPI_v15_2_H) */
