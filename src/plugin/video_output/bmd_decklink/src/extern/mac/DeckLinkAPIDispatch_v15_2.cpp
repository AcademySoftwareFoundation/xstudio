...
typedef IDeckLinkVideoFrameAncillaryPackets_v15_2 *(
    *CreateVideoFrameAncillaryPacketsInstanceFunc)(void);
...
IDeckLinkVideoFrameAncillaryPackets_v15_2 *
CreateVideoFrameAncillaryPacketsInstance_v15_2(void) {
    pthread_once(&gDeckLinkOnceControl, InitDeckLinkAPI);
