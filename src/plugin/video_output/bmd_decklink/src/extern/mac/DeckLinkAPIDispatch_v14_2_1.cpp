...
typedef IDeckLinkMetalScreenPreviewHelper_v14_2_1 *(*CreateMetalScreenPreviewHelperFunc)(void);
typedef IDeckLinkCocoaScreenPreviewCallback_v14_2_1 *(*CreateCocoaScreenPreviewFunc)(void *);
...
typedef IDeckLinkVideoFrameAncillaryPackets *(*CreateVideoFrameAncillaryPacketsInstanceFunc)(
    void);
...
static void InitDeckLinkAPI(void) {
    ...
    bundleURL = CFURLCreateWithFileSystemPath(
        kCFAllocatorDefault, CFSTR(kDeckLinkAPI_BundlePath), kCFURLPOSIXPathStyle, true);
    if (bundleURL != NULL) {
        gDeckLinkAPIBundleRef = CFBundleCreate(kCFAllocatorDefault, bundleURL);
        if (gDeckLinkAPIBundleRef != NULL) {
            gCreateIteratorFunc = (CreateIteratorFunc)CFBundleGetFunctionPointerForName(
                gDeckLinkAPIBundleRef, CFSTR("CreateDeckLinkIteratorInstance_0004"));
            gCreateAPIInformationFunc =
                (CreateAPIInformationFunc)CFBundleGetFunctionPointerForName(
                    gDeckLinkAPIBundleRef, CFSTR("CreateDeckLinkAPIInformationInstance_0001"));
            gCreateOpenGLPreviewFunc =
                (CreateOpenGLScreenPreviewHelperFunc)CFBundleGetFunctionPointerForName(
                    gDeckLinkAPIBundleRef, CFSTR("CreateOpenGLScreenPreviewHelper_0001"));
            gCreateOpenGL3PreviewFunc =
                (CreateOpenGL3ScreenPreviewHelperFunc)CFBundleGetFunctionPointerForName(
                    gDeckLinkAPIBundleRef, CFSTR("CreateOpenGL3ScreenPreviewHelper_0001"));
            gCreateMetalPreviewFunc =
                (CreateMetalScreenPreviewHelperFunc)CFBundleGetFunctionPointerForName(
                    gDeckLinkAPIBundleRef, CFSTR("CreateMetalScreenPreviewHelper_0001"));
            gCreateCocoaPreviewFunc =
                (CreateCocoaScreenPreviewFunc)CFBundleGetFunctionPointerForName(
                    gDeckLinkAPIBundleRef, CFSTR("CreateCocoaScreenPreview_0001"));
            gCreateVideoConversionFunc =
                (CreateVideoConversionInstanceFunc)CFBundleGetFunctionPointerForName(
                    gDeckLinkAPIBundleRef, CFSTR("CreateVideoConversionInstance_0001"));
            gCreateDeckLinkDiscoveryFunc =
                (CreateDeckLinkDiscoveryInstanceFunc)CFBundleGetFunctionPointerForName(
                    gDeckLinkAPIBundleRef, CFSTR("CreateDeckLinkDiscoveryInstance_0003"));
            gCreateVideoFrameAncillaryPacketsFunc =
                (CreateVideoFrameAncillaryPacketsInstanceFunc)CFBundleGetFunctionPointerForName(
                    gDeckLinkAPIBundleRef,
                    CFSTR("CreateVideoFrameAncillaryPacketsInstance_0001"));
        }
        CFRelease(bundleURL);
    }
}
...
IDeckLinkMetalScreenPreviewHelper_v14_2_1 *CreateMetalScreenPreviewHelper_v14_2_1(void) {
    pthread_once(&gDeckLinkOnceControl, InitDeckLinkAPI);
...
IDeckLinkCocoaScreenPreviewCallback_v14_2_1 *
CreateCocoaScreenPreview_v14_2_1(void *parentView) {
    pthread_once(&gDeckLinkOnceControl, InitDeckLinkAPI);
...
#define kBMDStreamingAPI_BundlePath                                                            \
    "/Library/Application Support/Blackmagic Design/Streaming/BMDStreamingAPI.bundle"
...
static void InitBMDStreamingAPI(void) {
    ...
    bundleURL = CFURLCreateWithFileSystemPath(
        kCFAllocatorDefault, CFSTR(kBMDStreamingAPI_BundlePath), kCFURLPOSIXPathStyle, true);
    if (bundleURL != NULL) {
        gBMDStreamingAPIBundleRef = CFBundleCreate(kCFAllocatorDefault, bundleURL);
        if (gBMDStreamingAPIBundleRef != NULL) {
            gCreateDiscoveryFunc = (CreateDiscoveryFunc)CFBundleGetFunctionPointerForName(
                gBMDStreamingAPIBundleRef, CFSTR("CreateBMDStreamingDiscoveryInstance_0002"));
            gCreateNALParserFunc = (CreateNALParserFunc)CFBundleGetFunctionPointerForName(
                gBMDStreamingAPIBundleRef, CFSTR("CreateBMDStreamingH264NALParser_0001"));
        }
...
IBMDStreamingDiscovery *CreateBMDStreamingDiscoveryInstance_v14_2_1() {
...
IBMDStreamingH264NALParser *CreateBMDStreamingH264NALParser_v14_2_1() {
    pthread_once(&gBMDStreamingOnceControl, InitBMDStreamingAPI);
