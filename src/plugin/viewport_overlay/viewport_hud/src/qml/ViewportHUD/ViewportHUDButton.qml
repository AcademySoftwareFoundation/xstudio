...
XsToolbarItem  {
    ...
    Rectangle {
        ...
        ListView {
            ...
            // XsToolBox which instantiates the button
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                anchors.fill: parent
                onClicked: {
                    viewport_hud_settings_dialog.raise()
                    viewport_hud_settings_dialog.show()
                    viewport_hud_settings_dialog.raise()
                    popup.visible = false
                }
            }
        ...
        XsModuleAttributesDialog {
            id: viewport_hud_settings_dialog
            title: "Viewport HUD Settings"
            attributesGroupName: "viewport_hud_settings"
        }
    }
