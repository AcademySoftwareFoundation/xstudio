    ...
    namespace viewport {
        ...
        class LaserStrokesRenderDataSet : public utility::BlindDataObject {
          public:
            ...
            void add_laser_strokes(const std::vector<std::shared_ptr<ui::canvas::Stroke>> &laser_strokes) {
        ...
        class PerImageAnnotationRenderDataSet : public utility::BlindDataObject {
          public:
            ...
            const CaptionVec & captions() const { 
              return captions_;
            }          

            const HandleStateVec & handle_states() const {
              return handles_;
            }

            const StrokeVec & strokes() const { 
              return strokes_;
            }
