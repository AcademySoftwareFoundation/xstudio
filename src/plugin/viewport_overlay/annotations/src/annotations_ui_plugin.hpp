...
class AnnotationsUI : public plugin::StandardPlugin {
  ...
  protected:
    ...
    void
    key_pressed(const int key, const std::string &context, const bool auto_repeat) override;
  ...
  private:
    ...
    module::ActionAttribute *action_attribute_{nullptr};

    module::BooleanAttribute *annotations_visible_{nullptr};
    ...
    module::IntegerAttribute *burn_intensity_{nullptr};
    module::StringChoiceAttribute *burn_blend_mode_{nullptr};

    module::IntegerAttribute *dodge_softness_{nullptr};
    module::IntegerAttribute *dodge_size_{nullptr};
    module::IntegerAttribute *dodge_intensity_{nullptr};
    module::StringChoiceAttribute *dodge_blend_mode_{nullptr};
    ...
    utility::Uuid toggle_visibility_hotkey_;
    ...
    float get_burn_intensity() const;
    float get_dodge_intensity() const;
