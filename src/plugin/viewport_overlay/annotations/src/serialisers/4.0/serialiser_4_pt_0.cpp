...
class AnnotationSerialiser_4_pt_0 : public AnnotationSerialiser {

  public:
    AnnotationSerialiser_4_pt_0() = default;
...
RegisterAnnotationSerialiser(AnnotationSerialiser_4_pt_0, 4, 0)

    void AnnotationSerialiser_4_pt_0::_serialise(
        const Annotation *anno, nlohmann::json &d) const {

    d = anno->canvas();
}

void AnnotationSerialiser_4_pt_0::_deserialise(Annotation *anno, const nlohmann::json &data) {
