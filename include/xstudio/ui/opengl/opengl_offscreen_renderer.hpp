...
class OpenGLOffscreenRenderer {
  public:
    ...
    [[nodiscard]] Imath::V2f dimensions() const { return fbo_dims_; }
    [[nodiscard]] unsigned int texture_handle() const { return tex_id_; }
    [[nodiscard]] GLenum texture_target() const { return tex_target_; }
