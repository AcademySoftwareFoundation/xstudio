...
class GLBlindTex {
  ...
  public:
    ...
    [[nodiscard]] const media::MediaKey &pending_media_key() const {
        return pending_media_key_;
    }
    [[nodiscard]] const media::MediaKey &media_key() const { return media_key_; }
    [[nodiscard]] const utility::time_point &when_last_used() const { return when_last_used_; }
  ...
  protected:
    ...
    [[nodiscard]] virtual size_t tex_size_bytes() const              = 0;
