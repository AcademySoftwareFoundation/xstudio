    ...
    */
    class Canvas {
      ...
      public:
        ...
        void
        update_stroke(const Imath::V2f &pt, float size_sens = 1.0f, float opacity_sens = 1.0f);
        ...
        void start_square(const utility::ColourTriplet &colour, float thickness, float opacity);
        void update_square(const Imath::V2f &corner1, const Imath::V2f &corner2);

        void start_circle(const utility::ColourTriplet &colour, float thickness, float opacity);
        void update_circle(const Imath::V2f &center, float radius);

        void start_arrow(const utility::ColourTriplet &colour, float thickness, float opacity);
        void update_arrow(const Imath::V2f &start, const Imath::V2f &end);

        void start_line(const utility::ColourTriplet &colour, float thickness, float opacity);
        ...
        const utility::clock::time_point &last_change_time() const { return last_change_time_; }
      ...
      private:
        ...
        template <typename T> T &current_item() { return std::get<T>(current_item_.value()); }
