...
struct Caption {
    ...
    Caption &operator=(const Caption &o) {
        text_               = o.text_;
    ...
    void set_opacity(const float o) { opacity_ = o; }

    void set_bg_opacity(const float o) { background_opacity_ = o; }

    void set_colour(const utility::ColourTriplet &c) { colour_ = c; }

    void set_bg_colour(const utility::ColourTriplet &c) { background_colour_ = c; }
  ...
  private:
    ...
    utility::ColourTriplet background_colour_ = {utility::ColourTriplet(0.0f, 0.0f, 0.0f)};
