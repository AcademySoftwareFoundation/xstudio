...
namespace ui {
    namespace qml {
        ...
        class FlagObject : public QObject {
            Q_OBJECT
          ...
          public:
            FlagObject(
                const std::string &name, const std::string &colour, QObject *parent = nullptr)
                : QObject(parent),
                  name_(QStringFromStd(name)),
                  colour_(QStringFromStd(colour)) {}
        ...
        class SessionUI : public QMLActor {
            ...
            Q_PROPERTY(QList<QObject *> mediaFlags READ mediaFlags NOTIFY mediaFlagsChanged)
          ...
          public:
            ...
            QList<QObject *> mediaFlags() { return media_flags_; }
          ...
          private:
            ...
            // QObject *findItem(const utility::Uuid &cuuid);
            // QUuid findCUuidFromUuid(const utility::Uuid &uuid) const;
