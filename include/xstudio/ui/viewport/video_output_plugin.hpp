...
class VideoOutputPlugin : public plugin::StandardPlugin {
  ...
  public:
    ...
    */
    ...
    // This method can be safely called from any thread
    void
    video_frame_consumed(const utility::time_point &frame_display_time = utility::clock::now());
    ...
    void
    viewport_playhead_changed(const std::string &viewport_name, caf::actor playhead) override;
    ...
    [[nodiscard]] caf::actor offscreen_viewport() const { return offscreen_viewport_; }
    ...
    [[nodiscard]] caf::actor colour_pipeline() const { return offscreen_colour_pipeline_; }
