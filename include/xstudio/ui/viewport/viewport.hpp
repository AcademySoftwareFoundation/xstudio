...
class Viewport : public module::Module {
  ...
  public:
    ...
    [[nodiscard]] const Imath::M44f &projection_matrix() const { return projection_matrix_; }
    ...
    [[nodiscard]] const std::string &pixel_info_string() const { return pixel_info_string_; }
    [[nodiscard]] caf::actor playhead() { return caf::actor_cast<caf::actor>(playhead_addr_); }
     ...
     */
    [[nodiscard]] bool use_bilinear_filtering() const;
     ...
     *         coordinate system.
     */
    [[nodiscard]] Imath::V2f pointer_position() const;

    /**
     *  @brief Return current pointer position as a pixel coordinate in the
     *         viewport window.
     */
    [[nodiscard]] Imath::V2i raw_pointer_position() const;

    /**
     *  @brief Get the bounding box, in the viewport area, of the current image
     *
     */
    [[nodiscard]] const std::vector<Imath::Box2f> &image_bounds_in_viewport_pixels() const {
     ...
     *
     */
    [[nodiscard]] const std::vector<Imath::V2i> &image_resolutions() const {
  ...
  private:
    ...
    [[nodiscard]] Imath::V4f normalised_pointer_position() const;
    ...
    [[nodiscard]] media_reader::ImageBufDisplaySetPtr
