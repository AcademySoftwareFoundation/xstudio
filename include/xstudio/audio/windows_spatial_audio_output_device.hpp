...
namespace audio {
     ...
     */
    class WindowsSpatialAudioOutputDevice : public AudioOutputDevice {
      public:
        WindowsSpatialAudioOutputDevice(const utility::JsonStore &prefs);

        ~WindowsSpatialAudioOutputDevice() override;
      ...
      private:
        ...
        CComPtr<ISpatialAudioClient> spatial_audio_client_;
