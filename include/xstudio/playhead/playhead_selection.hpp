...
class PlayheadSelection : public utility::Container {
  public:
    ...
    void
    insert_item(const utility::Uuid &uuid, const utility::Uuid &uuid_before = utility::Uuid());
    bool remove_item(const utility::Uuid &uuid);
    bool
    move_item(const utility::Uuid &uuid, const utility::Uuid &uuid_before = utility::Uuid());
    void clear();
