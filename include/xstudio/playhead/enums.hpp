...
typedef enum { CM_STRING = 0, CM_AB, CM_VERTICAL, CM_HORIZONTAL, CM_GRID, CM_OFF } CompareMode;
...
typedef enum { OM_FAIL = 0x0L, OM_NULL = 0x1L, OM_HOLD = 0x2L, OM_LOOP = 0x3L } OverflowMode;
