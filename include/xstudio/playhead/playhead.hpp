...
class PlayheadBase : public module::Module {
  public:
    ...
    [[nodiscard]] float velocity_multiplier() const { return velocity_multiplier_->value(); }
    ...
    [[nodiscard]] timebase::flicks
    clamp_timepoint_to_loop_range(const timebase::flicks pos) const;
