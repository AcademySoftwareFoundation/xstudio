...
class Session : public utility::Container {
  public:
    ...
    insert_group(const std::string &name, const utility::Uuid &uuid_before = utility::Uuid());
    ...
    [[nodiscard]] const std::string &push_playlist_name() const { return push_playlist_name_; }

    [[nodiscard]] utility::Uuid current_playlist_uuid() const { return current_playlist_uuid_; }
    void set_current_playlist_uuid(const utility::Uuid &uuid) { current_playlist_uuid_ = uuid; }

    [[nodiscard]] utility::Uuid viewed_playlist_uuid() const { return viewed_playlist_uuid_; }
    void set_viewed_playlist_uuid(const utility::Uuid &uuid) { viewed_playlist_uuid_ = uuid; }
    ...
    [[nodiscard]] fs::file_time_type session_file_mtime() const { return session_file_mtime_; }
