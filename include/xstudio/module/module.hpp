...
class Module {
  ...
  public:
    ...
    full_module(const std::vector<std::string> &attr_groups = std::vector<std::string>()) const;
    ...
    virtual void text_entered(const std::string & /*text*/, const std::string & /*context*/) {}
    ...
    [[nodiscard]] caf::actor self() const {
        return caf::actor_cast<caf::actor>(parent_actor_addr_);
    }
  ...
  protected:
    ...
    */
    ...
    void
    make_attribute_visible_in_viewport_toolbar(Attribute *attr, const bool make_visible = true);
    ...
    virtual void attribute_changed(const utility::Uuid & /*attr_uuid*/, const int /*role_id*/) {
    }
