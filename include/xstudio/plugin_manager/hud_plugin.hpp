...
class HUDPluginBase : public plugin::StandardPlugin {
  public:
     ...
     */
    [[nodiscard]] virtual const std::string &hud_name() const { return Module::name(); }
  ...
  protected:
     ...
     */
    void
    hud_element_qml(const std::string qml_code, const HUDElementPosition position = FullScreen);
    ...
    [[nodiscard]] bool visible() const {
        return globally_enabled_->value() && hud_data_->value();
    }
