...
class ShotgunClientActor : public caf::event_based_actor {
  ...
  private:
    ...
    void
    acquire_token_primary(caf::typed_response_promise<std::pair<std::string, std::string>> rp);
    ...
    void
    request_link(const std::string &link, caf::typed_response_promise<utility::JsonStore> rp);
