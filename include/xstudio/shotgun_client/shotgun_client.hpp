...
namespace shotgun_client {
  ...
  * checkbox	bool	true | false
  ? color	string	255,0,0 | pipeline_step	pipeline_step indicates the Task color   inherits from
  the Pipeline Step color.
  ...
  * duration	int | null		Range: -2147483648 to 2147483647. Length of time, in
  minutes
  * entity	object | null	{'type': <string>, "id": <int>}
  *  float	float | null		Range: -9999999999999.99 to 9999999999999.99
  ? footage	string | null	FF-ff	Frames must be < Preferences value for “Advanced >
  Number of frames per foot of film”   ? Format matches Preference value for “Formatting > Display
  of footage fields”. Example above is default.F=Feet f=Frames.
  ...
  * number	int | null		Range: -2147483648 to 2147483647.
  - password	string | null		Returned values of password fields are replaced   with
  ******* for security
  - serializable	object | null
  * status_list	string | null
  * text	string | null
  * timecode	int | null		Range: -2147483648 to 2147483647. Length of time, in
...
multi_entity	'is' ** Note: when used on multi_entity, this functions as you would expect
'contains' to function 'is_not' 'type_is' 'type_is_not' 'name_contains' 'name_not_contains' 'in'
'not_in'
