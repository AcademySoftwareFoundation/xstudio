...
template <typename result_type>
inline result_type preference_minimum(const utility::JsonStore &js, const std::string &path) {
    return preference_property<result_type>(js, path, "minimum");
}

template <typename result_type>
inline result_type preference_maximum(const utility::JsonStore &js, const std::string &path) {
...
template <typename result_type>
inline result_type preference_options(const utility::JsonStore &js, const std::string &path) {
    return preference_property<result_type>(js, path, "options");
}

inline std::string preference_category(const utility::JsonStore &js, const std::string &path) {
...
inline std::string preference_datatype(const utility::JsonStore &js, const std::string &path) {
...
template <typename value_type>
inline void
set_preference_value(utility::JsonStore &js, const value_type &value, const std::string &path) {
...
void preference_load_overrides(utility::JsonStore &js, const std::vector<std::string> &paths);
...
class GlobalStoreHelper : public json_store::JsonStoreHelper {
  public:
    GlobalStoreHelper(caf::actor_system &, const std::string &reg_name = global_store_registry);
