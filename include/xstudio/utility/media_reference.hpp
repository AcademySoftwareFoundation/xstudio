...
class MediaReference {
  public:
    ...
    [[nodiscard]] std::optional<caf::uri> uri(const int logical_frame, int &file_frame) const;
    [[nodiscard]] std::optional<std::pair<caf::uri, int>> pick_representative_frame(
        const std::optional<int> &starting_logical_frame = std::optional<int>()) const;
